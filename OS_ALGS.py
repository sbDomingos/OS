...
def menu_principal():
    while True:
        ...
        if escolha == '0':
            print("Encerrando o simulador... Ate logo!")
            break
        ...
        try:
            ...
            print("Valor de TTC invalido. Usando TTC = 0.")
            ttc = 0
        ...
        if escolha == '1':
            ...
            print("\n[Aviso: Algoritmo FCFS ainda nao implementado.]")
            ...
            print("\n[Aviso: Algoritmo SJF Preemptivo ainda nao implementado.]")
            ...
            try:
                ...
                print("\n[Aviso: Algoritmo Round Robin ainda nao implementado.]")
            except ValueError:
                print("Valor de Quantum invalido. Abortando simulacao.")
